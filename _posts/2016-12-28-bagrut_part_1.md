...
$latex \int_{0}^{\frac{\pi}{4}}\left(1-\frac{1}{2\cos^{2}x}\right)dx=\frac{\pi}{4}-\frac{1}{2}\int_{0}^{\frac{\pi}{4}}\frac{1}{\cos^{2}x}dx=\frac{\pi}{4}-\left[\frac{\sin x}{\cos x}\right]_{0}^{\frac{\pi}{4}}=\frac{\pi}{4}-1$
