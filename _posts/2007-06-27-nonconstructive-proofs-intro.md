...
<ol>
	<li>חשב את $latex b^2-4ac$</li>
	<li>הוצא שורש לתוצאה.</li>
	<li>הפחת את $latex b$ מהתוצאה.</li>
	<li>חלק את הכל ב-$latex 2a$</li>
	<li>קיבלת פתרון!</li>
</ol>
