...
הצעד הראשון הוא לשים לב לאבחנה הפשוטה הבאה: הטענה שהיחס $latex \frac{A}{B}$ הוא רציונלי שקולה לטענה שאפשר לצייר מחומש-עם-פנטגרמה באופן כזה שגם אורך צלע הפנטגרמה וגם אורך צלע המחומש שניהם מספרים <strong>טבעיים</strong>. כיוון אחד הוא ברור - אם נצליח לצייר מחומש-עם-פנטגרמה שכזה, אז $latex A$ יהיה מספר טבעי וגם $latex B$ יהיה מספר טבעי ולכן $latex \frac{A}{B}$ יהיה מספר רציונלי. הכיוון השני פחות מיידי: אם $latex \frac{A}{B}$ הוא רציונלי זה לא אומר ש-$latex A,B$ הם שלמים בהכרח - הביטו למשל על $latex \frac{1/4}{1/2}$ (רבע חלקי חצי) ששווה למספר הרציונלי $latex \frac{1}{2}$. מה שנכון הוא שאם היחס הוא מספר רציונלי, למשל $latex \frac{t}{s}$ עם $latex t,s$ שלמים, אז אפשר לצייר מחומש-עם-פנטגרמה כך שאורך צלעו של המחומש היא $latex s$ ואורך צלעה של הפנטגרמה הוא $latex t$ ולקבל מחומש-עם-פנטגרמה שאורכי צלעותיהם הם טבעיים.
...
ספציפית, בואו נסמן את צלע הפנטגרמה הגדולה ב-$latex A$, את צלע המחומש הגדול ב-$latex B$, את צלע הפנטגרמה הקטנה יותר ב-$latex a$ ואת צלע המחומש הקטן יותר ב-$latex b$. מה שנוכיח הוא ש-$latex a=A-B$ (ולכן בפרט $latex a&lt;A$ ואכן נקבל סדרה יורדת) ו-$latex b=2B-A$. בבירור אם $latex A,B$ היו טבעיים שניהם, כך גם $latex a,b$. עכשיו אני מציע לכם לקחת הפסקה מהפוסט, עכשיו משאתם יודעים <strong>מה</strong> אנחנו מנסים להוכיח, ולנסות להוכיח את זה בעצמכם. גם אם לא תצליחו, המשך הפוסט יהיה כנראה קל יותר לקריאה אחרי שחשבתם קצת על זה עצמאית.
...
עכשיו הגיע הזמן לטפל בפנטגרמה-שבתוך-המחומש-שבתוך-הפנטגרמה<strong>. </strong>מה אורך הצלע שלה? ובכן, כבר היכרנו אותו - זה בדיוק מה שסימנתי בתור $latex x$:
