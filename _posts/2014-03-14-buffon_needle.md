...
id: 3078
title: המחט של בופון
date: 2014-03-14T00:20:46+00:00
author: gadial
layout: post
guid: http://www.gadial.net/?p=3078
permalink: /2014/03/14/buffon_needle/
categories:
  - אנליזה מתמטית
  - מספרים
...
**[<img class="alignnone size-full wp-image-3079" alt="pi pie" src="http://www.gadial.net/wp-content/uploads/2014/03/pi-pie.jpg" width="176" height="176" />](http://www.gadial.net/wp-content/uploads/2014/03/pi-pie.jpg)**
...
**[<img class="alignnone size-full wp-image-3080" alt="needles1" src="http://www.gadial.net/wp-content/uploads/2014/03/needles1.png" width="811" height="399" />](http://www.gadial.net/wp-content/uploads/2014/03/needles1.png)**

קל להגיע למסקנה שיש הבדל כלשהו בין הסיטואציה שבה $latex l>d$, כלומר המחט גדולה מרוחב שורה ולכן אם היא נופלת בזווית שמאונכת לקווים המפרידים היא על בטוח חוצה קו מפריד שכזה, ובין הסיטואציה שבה $latex l\le d$. אני הולך לדבר **רק** על הסיטואציה השניה, מהטעם הפשוט שהנוסחה יוצאת הרבה יותר פשוטה ונחמדה בה, והרעיון עבור $latex l>d$ הוא אותו רעיון, עם עוד פרטים טכניים.
...
אוקיי, אז מה עושים? ראשית כל צריך לחדד עניינים כמו מה מרחב ההסתברות שלנו וכדומה. כשאנחנו "זורקים" מחט, מה אנחנו בעצם מגרילים? שני דברים - את ה**זווית** שלה (ביחס לציר $latex x$, כפי שבדרך כלל מחשבים זווית של ישרים) ואת ה**מיקום** שלה. אני אסתכל על אחת מהקצוות של המחט בתור ה"ראשית" שלה, והמיקום של המחט יהיה המיקום של הראשית הזו. הזווית תימדד ביחס לסיבוב שבו משאירים את הראשית קבועה (כלומר, מסובבים את המחט סביב הראשית ובודקים כמה סיבוב עם כיוון השעון נדרש כדי "להחזיר" אותה למצב שבו היא מתלכדת עם ציר $latex x$). לא קשה לראות שהמיקום ה**אופקי** של המחט, או השאלה באיזו שורה במחברת הראשית של המחט נפלה, הן חסרות חשיבות - כל מה שחשוב הוא הזווית, שהיא מספר $latex 0\le\theta\le2\pi$ (הנה פאי!) והגובה של הראשית מעל הקו המפריד התחתון בשורה, $latex 0\le h\le d$. הנה ציור שמבהיר את זה:

**[<img class="alignnone size-full wp-image-3081" alt="needles2" src="http://www.gadial.net/wp-content/uploads/2014/03/needles2.png" width="811" height="204" />](http://www.gadial.net/wp-content/uploads/2014/03/needles2.png)**
...
זה קירוב די פנטסטי. למעשה, פנטסטי **מדי**. $latex \frac{355}{113}$ הוא הקירוב הטוב ביותר לפאי באמצעות מספר רציונלי עם מונה ומכנה קטנים (הקירוב המפורסם האחר הוא $latex \frac{22}{7}$ שגם הוא מצויין אבל פחות טוב). זה מתחיל להסביר לנו למה לזאריני הטיל סיכה בדיוק 3408 פעמים - מספר מוזר ולא עגול לכל הדעות - ולמה הוא בחר את $latex l,d$ בצורה שנותנת $latex \frac{l}{d}=\frac{5}{6}$ הוא ניסה להנדס את הקירוב $latex \frac{355}{113}$!
...
כעת בואו נעבור לפתרון היפה יותר לבעיית המחט. הרעיון הוא לפתור בעיה כללית יותר: אנחנו זורקים מחט מאורך $latex l$ **כלשהו** (גם $latex l>d$) בצורה אקראית ושואלים **כמה** קווים המחט הולכת לחתוך. במילים אחרות, אנחנו מגדירים משתנה מקרי $latex X$ שסופר את החיתוכים של המחט עם הקווים המפרידים, ותוהים מה ה**[תוחלת](http://www.gadial.net/2010/08/14/random_variables/)** של המשתנה הזה, $latex E\left[X\right]$. פתרון כללי לשאלה הזו נותן גם פתרון כללי לשאלת ההסתברות במקרה של $latex l<d$, מכיוון שאז מספר החיתוכים הוא או 1 או 0, כלומר המשתנה המקרי הוא מה שנקרא **אינדיקטור** והתוחלת שלו שווה להסתברות שהוא יקבל 1.

ולמה כל כך מועיל לעבור לדבר על תוחלת? בגלל שיש לתוחלת תכונה נפלאה, קסם של ממש, שנקראת **לינאריות**. אם $latex X,Y$ הם שני משתנים מקריים, אז מתקיים $latex E\left[X+Y\right]=E\left[X\right]+E\left[Y\right]$, וזה נכון **גם אם המשתנים תלויים הסתברותית**.

איך ננצל את תכונת התוחלת הזו? על ידי התעלול הבא: נניח שאנחנו זורקים מחט באורך $latex l$ באקראי, אבל חושבים על המחט בתור **שתי** מחטים ש"הודבקו" אחת לשניה - מחט אחת מאורך $latex x$ והמחט השניה מאורך $latex y$. אז $latex E\left[l\right]=E\left[x+y\right]=E\left[x\right]+E\left[y\right]$ (כאן אני עושה מה שמכונה Abuse of notation - אני כותב את אורכי המחטים במקום לטרוח ולכתוב שמות של משתנים מקריים שמייצגים את המחטים מהאורך הזה).

אז מה קיבלנו? תשכחו לשניה מהסתברות ותוחלות וכאלה. יש לנו פונקציה $latex f$ שמוגדרת על כל הממשיים החיוביים, ומקיימת $latex f\left(x+y\right)=f\left(x\right)+f\left(y\right)$. משוואה כזו נקראת **משוואה פונקציונלית**, כי הנעלם בה הוא בכלל $latex f$ - אנחנו מבקשים לדעת אילו פונקציות $latex f$ הן פתרון למשוואה הזו. המשוואה הספציפית הזו היא מפורסמת - היא נקראת "המשוואה הפונקציונלית של קושי". בעבר כבר [הראיתי בבלוג](http://www.gadial.net/2010/03/27/exponent/) איך פותרים משוואה פונקציונלית דומה ("המשוואה הפונקציונלית האקספוננציאלית של קושי), המשוואה $latex f\left(x+y\right)=f\left(x\right)\cdot f\left(y\right)$. טכניקת הפתרון כאן היא דומה:
...
במקרה שלנו אנחנו יודעים ש-$latex f$ היא **מונוטונית**, כלומר מקיימת שאם $latex x<y$ אז $latex f\left(x\right)\le f\left(y\right)$ (למה? כי במקרה שלנו, אם $latex x<y$ אז $latex y=x+z$ כאשר גם $latex z$ חיובי, ואז $latex E\left[y\right]=E\left[x+y\right]=E\left[x\right]+E\left[z\right]\ge E\left[x\right]$). זה מסיים את הסיפור לכל $latex x$ ממשי ומוכיח ש-$latex f\left(x\right)=cx$. שכן אפשר לקחת שני רציונליים $latex r\_{1},r\_{2}$ כך ש-$latex r\_{1}<x<r\_{2}$ והם קרובים ל-$latex x$ כרצוננו, ויתקיים $latex f\left(r\_{1}\right)\le f\left(x\right)\le f\left(r\_{2}\right)$, דהיינו $latex cr\_{1}\le f\left(x\right)\le cr\_{2}$. כאשר $latex r\_{1}$ ו-$latex r\_{2}$ שואפים ל-$latex x$, הביטויים משמאל ומימין שואפים ל-$latex cx$ ולכן הפונקציה באמצע שואפת ל-$latex cx$ גם כן ("כלל הסנדוויץ'").
...
[<img class="alignnone size-full wp-image-3082" alt="needles3" src="http://www.gadial.net/wp-content/uploads/2014/03/needles3.png" width="811" height="267" />](http://www.gadial.net/wp-content/uploads/2014/03/needles3.png)
...
**[<img class="alignnone size-full wp-image-3083" alt="needles4" src="http://www.gadial.net/wp-content/uploads/2014/03/needles4.png" width="820" height="381" />](http://www.gadial.net/wp-content/uploads/2014/03/needles4.png)**
...
מי שהמציא/גילה את ההוכחה הנפלאה הזו הוא המתמטיקאי הצרפתי Joseph-Émile Barbier. אבל הוא לא עצר כאן - למעשה, מה שעשינו כאן הוא הוכחה לתוצאה עוד יותר מעניינת, שמושגת כאשר הופכים את מה שעשינו כאן על פיו. לצורך כך, בואו נאמר שצורה קמורה היא בעלת **רוחב קבוע** $latex d$ אם לכל שני קווים מקבילים שמשיקים לצורה, המרחק ביניהם הוא $latex d$. מעגל הוא בבירור צורה כזו, עם רוחב ששווה לקוטר שלה, אבל יש עוד צורות, למשל "[משולש רולו](http://en.wikipedia.org/wiki/Reuleaux_triangle)":

**[<img class="alignnone size-full wp-image-3084" alt="triangle" src="http://www.gadial.net/wp-content/uploads/2014/03/triangle.jpg" width="160" height="160" />](http://www.gadial.net/wp-content/uploads/2014/03/triangle.jpg)**

כעת, בהוכחה של הנוסחה עבור המחט של בופון השתמשנו במעגל עם קוטר $latex d$ כי זו צורה פשוטה ונחמדה, אבל **כל צורה קמורה** עם רוחב קבוע $latex d$ הייתה עובדת באותה המידה. הרוחב הקבוע אומר שלא משנה איך נשליך אותה על המחברת שלנו (כלומר, איך "סובבנו" אותה), או ששני קווי גבול במחברת ישיקו לה, או שבדיוק קו גבול אחד יעבור דרכה - ומכיוון שהיא קמורה, המשמעות היא שהוא יחתוך אותה בדיוק בשתי נקודות (לצורות לא קמורות זה לא עובד).

אם כן, ניקח צורה קמורה כלשהי מרוחב קבוע $latex d$ ועם היקף $latex l$. תוחלת מספר החיתוכים כשמשליכים אותה על המחברת הוא מצד אחד 2 מהסיבה שפירטתי כרגע, ומצד שני על פי הנוסחה הוא $latex \frac{2l}{\pi d}$. מסקנה: $latex \frac{2l}{\pi d}=2$, או $latex l=\pi d$. כלומר, ההיקף של הצורה הוא **תמיד** $latex \pi d$, בין אם היא מעגל ובין אם לאו. להציב $latex d=1$ נותן את התוצאה הזו בצורה אפילו יותר ברורה, למי שפספס אותי לרגע:
