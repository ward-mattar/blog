...
למי שנראה לו מוזר שאני מגדיר כאן משתנה בזמן שאני בעצם מגדיר פונקציה או משהו - כן, ברוכים הבאים ל-Javascript, זה הדבר הכי מוזר שכנראה תראו פה, אז פשוט תתעלמו. העיקר שאמור לעניין אותנו פה הוא שאני קולט <strong>מראש</strong> את מספר הצמתים בגרף - {::nomarkdown}\( n\){:/nomarkdown} - ואני לא הולך לאפשר לשנות אותו בהמשך כי אין בכך צורך עבור הגרפים שלי. הקשתות, לעומת זאת, מתחילות בתור רשימה ריקה.
...
בואו נתחיל עם פונקציה שמוסיפה קשת לגרף. כאן כבר יש לנו "בעיה", כי קשת מוגדרת על ידי זוג הקודקודים שהיא מחוברת אליהם, אבל הגרף לא מכוון, אז הקשת {::nomarkdown}\( (3,5)\){:/nomarkdown} היא אותו דבר כמו {::nomarkdown}\( (5,3)\){:/nomarkdown}. אז יש בדיקות מפורשות עבור זה ועבור עוד דברים:
