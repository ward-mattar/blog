...
ברשותכם, דיון פרקטי יחסית באופיו. למי שרוצה, יש לי <a href="http://www.gadial.net/2012/07/10/all_sorts_of_slow_sorts/">פוסט על אלגוריתמי מיון</a> שגם מציג את הדיון על סיבוכיות זמן ריצה הרבה יותר בפירוט. כרגע אני רוצה להסביר מדוע אלגוריתמי הפירוק לגורמים ובדיקת הראשוניות שהצגתי כאן הם גרועים. נתחיל מזה שהם לא גרועים באופן אבסולוטי - הם אחלה! קל לתכנת אותם והם מחזירים תשובה נכונה על קלטים קטנים. כמה קטנים? נאמר, בני 10 ספרות? אולי קצת יותר. להרבה צרכים פרקטיים זה די והותר. אבל לא לכולם. למשל, הצפנה: במערכת הצפנה מודרנית כדוגמת RSA שמתבססת על מספרים ראשוניים, מדובר על מספרים בני מאות ספרות. עכשיו, פרופורציות: מספר השניות שחלפו מאז תחילת היקום הוא מסדר גודל של {::nomarkdown}\( 10^{17}\){:/nomarkdown}. אז אם אני רוצה לבדוק האם מספר בן 100 ספרות הוא ראשוני ואני פשוט עובר על כל המספרים שקטנים ממנו, יהיה עלי לעבור על {::nomarkdown}\( 10^{100}\){:/nomarkdown} מספרים בערך. אפילו אם אניח שאני בודק {::nomarkdown}\( 10^{20}\){:/nomarkdown} מספרים בשניה, זה עדיין אומר {::nomarkdown}\( 10^{80}\){:/nomarkdown} שניות. ומה עם שיטת "עד השורש"? הו, היא מצויינת: היא חוסכת הרבה זמן. במקום לבדוק {::nomarkdown}\( 10^{100}\){:/nomarkdown} מספרים, יהיה צורך לבדוק רק {::nomarkdown}\( 10^{50}\){:/nomarkdown} מספרים. מה שיקח, בהערכה הנדיבה שלי, {::nomarkdown}\( 10^{30}\){:/nomarkdown} שניות. אופס, עדיין יותר מגיל היקום. וב-RSA עובדים עם מספרים בני הרבה יותר מ-100 ספרות.
