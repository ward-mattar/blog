...
מה שנכלל באיור הזה הוא <strong>מצבים</strong>, שהם עיגולים, ונתתי להם את השמות $latex q_{0},q_{1}$. יש <strong>מעברים</strong> בין מצבים שמתוארים על ידי חצים ("אי שינוי מצב" מתואר על ידי מעבר ממצב לעצמו) כשעל החצים יש את סימון התו מהקלט שקראנו וגרם למעבר הזה. את $latex q_{0}$ סימנו בשני עיגולים כדי לומר שזה מצב <strong>מקבל</strong>, כזה שאם האלגוריתם מסיים את ריצתו בו אז התשובה של האלגוריתם היא "כן", וכמו כן יש חץ משום מקום שנכנס לתוך $latex q_{0}$ כדי לתאר שזה המצב <strong>ההתחלתי</strong> שבו האלגוריתם מתחיל את ריצתו.
...
כדי שהתיאור הפורמלי שלנו של אוטומט יהיה שלם, צריך לתאר לא רק את האוטומט עצמו אלא גם מה זה אומר, פורמלית, שהאוטומט "רץ" על מילה. ריצה היא בסך הכל סדרת מצבים שהראשון שבהם הוא המצב ההתחלתי של האוטומט וכל מצב מתקבל מקודמו על ידי קריאת אות מהקלט ועל פי פונקציית המעברים. אם $latex w=\sigma_{1}\sigma_{2}\dots\sigma_{n}$ היא מילה בת $latex n$ אותיות, אז <strong>ריצה</strong> על המילה הזו תהיה סדרה $latex p^{0},p^{1},\dots,p^{n}$ של מצבים שמקיימת $latex p^{0}=q_{0}$ ולכל $latex 0&lt;i\le n$ מתקיים $latex p^{i}=\delta\left(p^{i-1},\sigma_{i}\right)$. לבסוף, $latex w$ מתקבלת על ידי האוטומט אם ורק אם $latex p^{n}\in F$.

כדי לפשט בסימונים ובכתיבה, מה שנוח לעשות הוא לקחת את פונקציית המעברים של האוטומט ו<strong>להרחיב אותה למילים</strong>. דהיינו, במקום לדבר על $latex \delta:Q\times\Sigma\to Q$ מדברים על פונקציה $latex \delta:Q\times\Sigma^{*}\to Q$ שאומרת לאן האוטומט מגיע בריצה שלו על כל מילה אפשרית. מה שקריטי להבין כאן הוא שהפונקציה מוגדרת על כל זוג של מצב ומילה, אבל רק ההגדרה שלה על מצב ואות היא חלק מההגדרה של האוטומט; כל השאר <strong>נובע</strong> מההגדרה הזו באופן חד-ערכי (לפעמים מסמנים את הפונקציה המורחבת ב-$latex \hat{\delta}$ או משהו דומה כדי שההבדל בין שתי הפונקציות יהיה ברור).

קל לתאר את $latex \delta$ המורחבת הזו באופן אינדוקטיבי. ראשית, נסמן ב-$latex \varepsilon$ את המחרוזת הריקה - מחרוזת ללא תווים (אני מקווה שאין לאף אחד כאן בעיה עם המושג הזה - הרי הוא קיים גם בשפות תכנות סטנדרטיות). אז ברור ש-$latex \delta\left(q,\varepsilon\right)=q$ כי אם עוד לא קראנו כלום אנחנו נשארים במצב שהתחלנו בו. כמו כן, אם $latex w$ היא מילה כלשהי ו-$latex \sigma$ היא אות כלשהי, אז מתקיים $latex \delta\left(q,w\sigma\right)=\delta\left(\delta\left(q,w\right),\sigma\right)$, כלומר המצב שאליו מגיעים מ-$latex q$ על ידי קריאת $latex w\sigma$. הוא המצב שאליו מגיעים על ידי כך שקודם כל קוראים את $latex w$, מגיעים למצב כלשהו, ואז בו קוראים את $latex \sigma$ ומבצעים מעבר אחד נוסף. למעשה, אם רוצים להיות ממש פורמליים אז <strong>מגדירים</strong> את פונקציית המעברים המורחבת על ידי שתי המשוואות הללו (עבור $latex \varepsilon$ ועבור $latex w\sigma$) - זו המחשה להגדרה אינדוקטיבית של פונקציה.

כדי לוודא שהבנו, הנה הוכחה טכנית של טענה קצת יותר כללית על פונקציית המעברים: $latex \delta\left(q,w_{1}w_{2}\right)=\delta\left(\delta\left(q,w_{1}\right),w_{2}\right)$ כאשר $latex w_{1},w_{2}$ מילים כלשהן (מה שראינו - או הגדרנו - קודם הוא שזה נכון עבור $latex w_{2}$ שהיא אות). הוכחה של טענה כמו זו היא באינדוקציה על האורך של $latex w_{2}$, כשמקרה הבסיס ($latex \left\|w_{2}\right\|=0$ ולכן $latex w_{2}=\varepsilon$) טריוויאלי. עבור הצעד, מפרקים $latex w_{2}=w\sigma$ ומניחים שהטענה כבר נכונה עבור $latex w_{1}w$, ואז מקבלים את שרשרת המעברים הבאה:

$latex \delta\left(q,w_{1}w\sigma\right)=\delta\left(\delta\left(q,w_{1}w\right),\sigma\right)=$

$latex \delta\left(\delta\left(\delta\left(q,w_{1}\right),w\right),\sigma\right)=\delta\left(\delta\left(q,w_{1}\right),w\sigma\right)=\delta\left(\delta\left(q,w_{1}\right),w_{2}\right)$

עכשיו אפשר סוף סוף לתת את ההגדרה האחרונה שלנו - מה השפה שהאוטומט מזהה, או כפי שיותר נהוג לומר - <strong>מקבל</strong>. אם $latex A=\left(\Sigma,Q,q_{0},\delta,F\right)$ הוא אוטומט, אז נגדיר $latex L\left(A\right)=\left\{ w\in\Sigma^{*}\|\delta\left(q_{0},w\right)\in F\right\} $. שפה שמתקבלת על ידי אוטומט סופי דטרמיניסטי כלשהו נקראת <strong>שפה רגולרית</strong>.
...
ראשית, לכל $latex 0\le k\le n$ נגדיר $latex p^{k}=\delta\left(q_{0},a^{k}\right)$. מכיוון שהגדרנו $latex n+1$ מצבים, לפחות אחד ממצבי האוטומט מתקבל פעמיים באופן הזה, כלומר יש $latex i&lt;j$ כך ש-$latex \delta\left(q_{0},a^{i}\right)=\delta\left(q_{0},a^{j}\right)$. כמו כן האוטומט מקבל, על פי ההנחה שלנו, כל מילה ב-$latex L$, ולכן $latex \delta\left(q_{0},a^{n}b^{n}\right)\in F$. עכשיו בואו תראו קסם:

$latex \delta\left(q_{0},a^{n}b^{n}\right)=\delta\left(\delta\left(q_{0},a^{j}\right)a^{n-j}b^{n}\right)=\delta\left(\delta\left(q_{0},a^{i}\right)a^{n-j}b^{n}\right)=\delta\left(q_{0},a^{n-j+i}b^{n}\right)$
