...
date: 2012-08-21T00:17:26+00:00
author: gadial
layout: post
guid: http://www.gadial.net/?p=2140
permalink: /2012/08/21/cranks_from_mars/
categories:
...
[<img class="alignnone size-thumbnail wp-image-2145" title="moon" src="http://www.gadial.net/wp-content/uploads/2012/08/moon-150x150.png" alt="" width="150" height="150" />](http://www.gadial.net/wp-content/uploads/2012/08/moon.png)

תחילת הדיון הייתה בכך שדודי פרסם נוסח סטנדרטי של הידיעה. חיש קל פרסם מישהו [קישור לאתר הידען](http://www.hayadan.org.il/mars-near-its-farest-point-2508108/) שמפריך את הידיעה.

ענה לו דודי:

> קראת כמה שטויות כתב אבי בליזובסקי, עורך אתר "הידען", שאינו ידען כלל ?
> 
...
[<img class="alignnone size-full wp-image-2144" title="Angular_dia_formula" src="http://www.gadial.net/wp-content/uploads/2012/08/Angular_dia_formula.jpg" alt="" width="583" height="227" />](http://www.gadial.net/wp-content/uploads/2012/08/Angular_dia_formula.jpg)

כאן המשולש נוצר על ידי שני הקווים שהולכים אל נקודות הקצה של ה"דיסק" (שנראה באיור כמו אליפסה). $latex d$ הוא הקוטר של הדיסק, $latex D$ הוא המרחק שלו מאיתנו, ו-$latex \delta$ היא הקוטר הזוויתי. המשולש הגדול אינו משולש ישר זווית, אבל אפשר לחלק אותו לשני משולשים כאלו שכל אחד מהם כולל זווית של $latex \frac{\delta}{2}$. כעת, אחת מהפונקציות הטריגונומטריות הבסיסיות היא פונקציית הטנגנס; טנגנס של זווית במשולש ישר זווית הוא המנה של הניצב שמול הזווית, והניצב שליד הזווית. כלומר, $latex \tan\left(\frac{\delta}{2}\right)=\frac{1}{2}\frac{d}{D}$ (החצי באגף ימין נובע מכך שאורך הצלע שמול הזווית הוא $latex \frac{d}{2}$ - זכרו שאנו מסתכלים רק על אחד מהמשולשים הקטנים). זה לא עוזר לנו לקבל את $latex \delta$, אז אנחנו מפעילים על שני האגפים את הפונקציה הנגדית לטנגנס, שנקראת ארק-טנגנס (ובסימון: $latex \mbox{atan}$) ומקבלים $latex \frac{\delta}{2}=\mbox{atan}\frac{1}{2}\frac{d}{D}$, או $latex \delta=2\mbox{atan}\frac{1}{2}\frac{d}{D}$. זו כל הנוסחה שאנחנו צריכים.

את $latex \mbox{atan}$ אפשר לחשב עבור איזה קירוב שנרצה בעזרת שיטות סטנדרטיות, אבל במקרה שלנו אפשר להזניח עוד יותר. עבור זוויות קטנות (שנמדדות ב**[רדיאנים](http://www.gadial.net/2008/01/11/radians/)**, אבל אם אתם לא מכירים את המושג הזה, לא נורא), $latex \mbox{atan}\delta$ שווה בערך ל-$latex \delta$, עד כדי הפרש שהוא זניח. אצלנו $latex \frac{d}{D}$ יהיה מספר קטן מאוד, כי המרחק של הגופים מאיתנו הוא עצום ביחס לקוטר שלהם, ולכן גם $latex \delta$ יצא קטן ($latex \mbox{atan}$ של ערכים קטנים הוא קטן) ולכן אפשר להשתמש בקירוב הזה ולקבל שבערך, $latex \delta\approx\frac{d}{D}$. זו כבר נוסחה פשוטה וברורה - ה"גודל" שאנחנו רואים בפועל הוא פשוט הגודל האמיתי, חלקי המרחק של האובייקט מאיתנו. יופי, אז מה המספרים הרלוונטיים עבור מאדים והירח?
...
ובכן, מרחק השמש מכדור הארץ הוא 149,600,000 קילומטרים (כנראה שהאפסים בסוף הם לא מדוייקים&#8230;) ורדיוסה הוא 696,342 קילומטר (השמש היא **ענקית** בהשוואה לירח או מאדים). הקוטר הזוויתי שמתקבל הוא $latex 0.00930\dots$, שקרוב מאוד לקוטר הזוויתי של הירח, $latex 0.008565$ - השמש גדולה ממנו פי $latex 1.089\dots$, מה שלא משמעותי במיוחד. אם כן, החישובים יוצאים כפי שאנו מצפים שיצאו.

עוד שעשוע נחמד הוא לשחק ב"נדמה לי" - מה היה קורה אם מאדים אכן היה מתקרב לכדור הארץ עד כדי כך שגודלו היה נראה כמו גודל הירח? ובכן, ראשית יש למצוא את המרחק הזה. אנו רוצים שיתקיים $latex \frac{d\_{moon}}{D\_{moon}}=\frac{d\_{mars}}{D\_{mars}}$, והנעלם כאן הוא $latex D\_{mars}$, ששווה ל-$latex D\_{mars}=\frac{d\_{mars}\cdot D\_{moon}}{d_{moon}}$. על ידי הצבת המספרים נקבל $latex 791,428$ קילומטר. אפשר לעשות את החישוב הזה גם בראש באופן מקורב - זה בעצם שווה למרחק הירח מכדור הארץ, כשהוא מוכפל ביחס שבין רדיוס מאדים ורדיוס הירח. אמרנו שרדיוס מאדים גדול פי 2 מרדיוס הירח, אז מרחק מאדים צריך להיות גדול פי 2 ממרחק הירח, כלומר בסביבות ה-800,000 קילומטר.

עכשיו, אם מאדים יתקרב לכדור הארץ במידה הזו, זה יהיה אסון אדיר. למה? מכיוון שלכבידה של הירח יש השפעה על כדור הארץ, שבאה לידי ביטוי למשל בתופעות השפל והגאות. אם מאדים יתקרב למרחק גדול פי 2 מזה של הירח, גם הכבידה שלו תתחיל לשחק תפקיד ותחולל שמות בכדור הארץ. למה עכשיו הכבידה שלו לא מחוללת שמות? מכיוון שכבידה קטנה ביחס ל**ריבוע** המרחק, ולכן כאשר המרחק גדול השפעת הכבידה הופכת לזניחה. אבל אם מאדים יתקרב עד כדי כך&#8230;

הנה לנו נתונים שהיו חסרים עד כה: המסה של הירח היא $latex 7.3477\times10^{22}$ ק"ג. המסה של מאדים היא $latex 64.185\times10^{22}$ ק"ג, כלומר בערך פי 9 מאשר הירח. אם המרחק של מאדים מכדור הארץ הוא פי 2 מהמרחק של הירח מכדור הארץ, אז השפעת הכבידה של מאדים חלשה פי 4 מזו של הירח; אבל מכיוון שהמסה של מאדים גדולה פי 9 מזו של הירח גם השפעת הכבידה של מאדים גדולה פי 9, ולכן בסך הכל נקבל שהכבידה שמאדים מפעיל על כדור הארץ גדולה **פי** **2** מזו שהירח מפעיל! כלומר, מאדים יהפוך להיות הרכיב ה**דומיננטי** כאן! אני בקושי מבין בגאות ושפל בעצמי ולכן לא יכול לומר אם זה יוביל להצפות שטפונות וחורבן, אבל אם הייתי עושה סרט הוליוודי כנראה שזה מה שהיה קורה (בפועל, כפי שראינו, המרחק של מאדים הוא גדול פי 137 מזה של הירח, ולכן השפעת הכבידה היא קטנה בערך פי 18769, כך שהיא באמת זניחה).
