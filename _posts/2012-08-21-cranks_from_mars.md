...
כאן המשולש נוצר על ידי שני הקווים שהולכים אל נקודות הקצה של ה"דיסק" (שנראה באיור כמו אליפסה). {::nomarkdown}\( d\){:/nomarkdown} הוא הקוטר של הדיסק, {::nomarkdown}\( D\){:/nomarkdown} הוא המרחק שלו מאיתנו, ו-{::nomarkdown}\( \delta\){:/nomarkdown} היא הקוטר הזוויתי. המשולש הגדול אינו משולש ישר זווית, אבל אפשר לחלק אותו לשני משולשים כאלו שכל אחד מהם כולל זווית של {::nomarkdown}\( \frac{\delta}{2}\){:/nomarkdown}. כעת, אחת מהפונקציות הטריגונומטריות הבסיסיות היא פונקציית הטנגנס; טנגנס של זווית במשולש ישר זווית הוא המנה של הניצב שמול הזווית, והניצב שליד הזווית. כלומר, {::nomarkdown}\( \tan\left(\frac{\delta}{2}\right)=\frac{1}{2}\frac{d}{D}\){:/nomarkdown} (החצי באגף ימין נובע מכך שאורך הצלע שמול הזווית הוא {::nomarkdown}\( \frac{d}{2}\){:/nomarkdown} - זכרו שאנו מסתכלים רק על אחד מהמשולשים הקטנים). זה לא עוזר לנו לקבל את {::nomarkdown}\( \delta\){:/nomarkdown}, אז אנחנו מפעילים על שני האגפים את הפונקציה הנגדית לטנגנס, שנקראת ארק-טנגנס (ובסימון: {::nomarkdown}\( \mbox{atan}\){:/nomarkdown}) ומקבלים {::nomarkdown}\( \frac{\delta}{2}=\mbox{atan}\frac{1}{2}\frac{d}{D}\){:/nomarkdown}, או {::nomarkdown}\( \delta=2\mbox{atan}\frac{1}{2}\frac{d}{D}\){:/nomarkdown}. זו כל הנוסחה שאנחנו צריכים.

את {::nomarkdown}\( \mbox{atan}\){:/nomarkdown} אפשר לחשב עבור איזה קירוב שנרצה בעזרת שיטות סטנדרטיות, אבל במקרה שלנו אפשר להזניח עוד יותר. עבור זוויות קטנות (שנמדדות ב<strong><a href="http://www.gadial.net/2008/01/11/radians/">רדיאנים</a></strong>, אבל אם אתם לא מכירים את המושג הזה, לא נורא), {::nomarkdown}\( \mbox{atan}\delta\){:/nomarkdown} שווה בערך ל-{::nomarkdown}\( \delta\){:/nomarkdown}, עד כדי הפרש שהוא זניח. אצלנו {::nomarkdown}\( \frac{d}{D}\){:/nomarkdown} יהיה מספר קטן מאוד, כי המרחק של הגופים מאיתנו הוא עצום ביחס לקוטר שלהם, ולכן גם {::nomarkdown}\( \delta\){:/nomarkdown} יצא קטן ({::nomarkdown}\( \mbox{atan}\){:/nomarkdown} של ערכים קטנים הוא קטן) ולכן אפשר להשתמש בקירוב הזה ולקבל שבערך, {::nomarkdown}\( \delta\approx\frac{d}{D}\){:/nomarkdown}. זו כבר נוסחה פשוטה וברורה - ה"גודל" שאנחנו רואים בפועל הוא פשוט הגודל האמיתי, חלקי המרחק של האובייקט מאיתנו. יופי, אז מה המספרים הרלוונטיים עבור מאדים והירח?
...
ובכן, מרחק השמש מכדור הארץ הוא 149,600,000 קילומטרים (כנראה שהאפסים בסוף הם לא מדוייקים...) ורדיוסה הוא 696,342 קילומטר (השמש היא <strong>ענקית</strong> בהשוואה לירח או מאדים). הקוטר הזוויתי שמתקבל הוא {::nomarkdown}\( 0.00930\dots\){:/nomarkdown}, שקרוב מאוד לקוטר הזוויתי של הירח, {::nomarkdown}\( 0.008565\){:/nomarkdown} - השמש גדולה ממנו פי {::nomarkdown}\( 1.089\dots\){:/nomarkdown}, מה שלא משמעותי במיוחד. אם כן, החישובים יוצאים כפי שאנו מצפים שיצאו.

עוד שעשוע נחמד הוא לשחק ב"נדמה לי" - מה היה קורה אם מאדים אכן היה מתקרב לכדור הארץ עד כדי כך שגודלו היה נראה כמו גודל הירח? ובכן, ראשית יש למצוא את המרחק הזה. אנו רוצים שיתקיים {::nomarkdown}\( \frac{d_{moon}}{D_{moon}}=\frac{d_{mars}}{D_{mars}}\){:/nomarkdown}, והנעלם כאן הוא {::nomarkdown}\( D_{mars}\){:/nomarkdown}, ששווה ל-{::nomarkdown}\( D_{mars}=\frac{d_{mars}\cdot D_{moon}}{d_{moon}}\){:/nomarkdown}. על ידי הצבת המספרים נקבל {::nomarkdown}\( 791,428\){:/nomarkdown} קילומטר. אפשר לעשות את החישוב הזה גם בראש באופן מקורב - זה בעצם שווה למרחק הירח מכדור הארץ, כשהוא מוכפל ביחס שבין רדיוס מאדים ורדיוס הירח. אמרנו שרדיוס מאדים גדול פי 2 מרדיוס הירח, אז מרחק מאדים צריך להיות גדול פי 2 ממרחק הירח, כלומר בסביבות ה-800,000 קילומטר.
