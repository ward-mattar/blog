...
date: 2012-12-16T23:43:24+00:00
author: gadial
layout: post
guid: http://www.gadial.net/?p=2277
permalink: /2012/12/16/the_surprise_examination/
categories:
...
**[<img class="alignnone size-full wp-image-2279" title="hashed mehshvieit_big" src="http://www.gadial.net/wp-content/uploads/2012/12/hashed-mehshvieit_big.jpg" alt="" width="324" height="500" />](http://www.gadial.net/wp-content/uploads/2012/12/hashed-mehshvieit_big.jpg)**
...
ועכשיו משאמרתי את זה, בואו נעבור לניתוח מתמטי יותר של העניין, שימחיש למה הפרדוקס הזה מעניין ועמוק יותר דווקא אם מנסים בכוח להימנע מלקבל את הפתרונות ה"פשוטים" שלו. למי שמעוניין בהעמקה גדולה יותר מזו שאגיע אליה בפוסט, הנה [מאמר סקירה](http://www-math.mit.edu/~tchow/unexpected.pdf) מצוין.

בגישה המתמטית שאני מציג כאן, המושג של "ידע" מזוהה עם "יכיחות". לכן אני צריך איזה שהוא סימון כדי לתאר "יכיח": אני אשתמש ב-$latex \mbox{Pr}\left[\varphi\right]$ (מלשון "Provable") כדי לומר "הפסוק $latex \varphi$ יכיח". בנוסף, אשתמש במשתנה $latex D$ כדי לתאר את היום שבו בוחן הפתע מתקיים. עם הסימונים הללו, אפשר לנסות ולתאר את מה שגוסונובסקי אומר לתלמידים כך (קראו את זה בתור "המבחן יהיה באחד מהימים $latex 1,2,3,4,5$ וגם לכל יום $latex n$, אם המבחן לא התקיים עד אליו, לא ניתן להוכיח מכך שהוא יתקיים ביום $latex n$"):

$latex S\equiv\left(D\in\left\{ 1,2,3,4,5\right\} \right)\wedge\bigwedge_{n=1}^{5}\left(D\ge n\to\neg\mbox{Pr}\left[D\ge n\to D=n\right]\right)$

ה-$latex S\equiv$ בהתחלה אומר שזה השם שאני נותן לפסוק שמימין ל-$latex \equiv$; זה יהיה חשוב בהמשך.

האם הפסוק הזה ממדל טוב את דבריו של גוסונובסקי? לא ממש. בואו ננסה לחשוב איך התלמידים יוכיחו בעזרתו ש-$latex D\ne5$: הם יניחו בשלילה ש-$latex D=5$ (ולכן בפרט $latex D\ge5$) ולכן כדי להגיע לסתירה די להם להראות ש-$latex \mbox{Pr}\left[D\ge5\to D=5\right]$. הבעיה היא שאי אפשר להוכיח את הטענה הזו בלי ידע נוסף - במקרה הזה, ש-$latex D\in\left\{ 1,2,3,4,5\right\} $.

"אבל רגע!" אולי אתם אומרים, "הרי הידע הזה הוא בדיוק מה שהיה בחלק השמאלי של הפסוק!". זה כמובן נכון, אבל הפסוק הזה **הוא לא אחת מהאקסיומות** שעליהן הסימון $latex \mbox{Pr}\left[D\ge n\to D=n\right]$ מדבר כשהוא מדבר על קיום הוכחה אלא אם אנחנו בוחרים להניח את זה במובלע, ואנחנו לא. האקסיומות היחידות שאנחנו מניחים במובלע הן האקסיומות הרגילות של לוגיקה מסדר ראשון. אם אנחנו רוצים עוד אקסיומות, בואו נציין אותן במפורש: נסמן ב-$latex \mbox{Pr}_{A}\left[\varphi\right]$ את הטענה "$latex \varphi$ יכיח מ-$latex A$".

אם כן, מה שטבעי לעשות הוא להגדיר

$latex A\equiv\left(D\in\left\{ 1,2,3,4,5\right\} \right)$

ועכשיו להגדיר

$latex S\equiv\left(D\in\left\{ 1,2,3,4,5\right\} \right)\wedge\bigwedge\_{n=1}^{5}\left(D\ge n\to\neg\mbox{Pr}\_{A}\left[D\ge n\to D=n\right]\right)$

הניסוח הזה קולע לא רע למטרה. בואו נראה שהתלמידים מסוגלים להוכיח איתו ש-$latex D\ne5$. כדי לעשות את זה, התלמידים יניחו בשלילה ש-$latex D=5$, ואז יוכיחו שמתקיים $latex \mbox{Pr}_{A}\left[D\ge5\to D=5\right]$ על ידי כך ש-$latex A$ נותן לנו ש-$latex D\le5$ ולכן אם $latex D\ge5$ אז $latex D=5$, שזו דרך אחרת לכתוב $latex D\ge5\to D=5$.

רק שעכשיו התלמידים בברוך. השלב הבא הוא להוכיח ש-$latex D\ne4$, ואז זה **הם לא יכולים לעשות** מתוך $latex A$. בואו ניזכר שניה איך הטיעון אמור ללכת עכשיו: התלמידים יניחו בשלילה ש-$latex D=4$. עכשיו הם רק צריכים להראות שמתקיים $latex \mbox{Pr}_{A}\left[D\ge4\to D=4\right]$. ההוכחה תלך ככה: בגלל שאנחנו יודעים ש-$latex D\le4$&#8230; רגע, רגע, רגע! מה זה "אנחנו יודעים"? מי יודע? אם כל מה שההוכחה יכולה להשתמש בו הוא $latex A$, אז ההוכחה **לא יודעת** ש-$latex D\ne5$, ובלי הידע הזה לא ניתן להוכיח ש-$latex D\le4$ וההוכחה הולכת לכל הרוחות.

כדי להסיק את $latex D\ne5$ בתוך ההוכחה של $latex D\ge4\to D=4$, ההוכחה הזו צריכה לקבל כאקסיומה בדיוק את הכלי שהיה לסטודנטים כשהם הוכיחו ש-$latex D\ne5$, והכלי הזה הוא הנוסחה $latex S$ עצמה. זה לב העניין. אנחנו רואים שהמעגליות הזו היא קריטית עבור הטיעון של התלמידים. במילים אחרות, הניסוח הנכון של $latex S$ הוא זה:

$latex S\equiv\left(D\in\left\{ 1,2,3,4,5\right\} \right)\wedge\bigwedge\_{n=1}^{5}\left(D\ge n\to\neg\mbox{Pr}\_{S}\left[D\ge n\to D=n\right]\right)$

כאן אפשר לעצור ולהגיד "יש מעגליות? לא משחקים!". לגיטימי. אפשר גם לומר "אין שום דרך לכתוב פסוק $latex S$ כזה בגלל שהוא מכיל את עצמו וזו סתירה" או משהו בסגנון, אבל זה כבר לא יהיה לגיטימי. אחד מהקסמים המגניבים ביותר בלוגיקה - קסם שהוא בעל תפקיד חשוב בהוכחת משפט אי השלמות של גדל - הוא ש**אפשר** לבנות פסוקים שמתייחסים כך לעצמם, בעזרת טכניקה עקיפה ומחוכמת שלא אציג כרגע אבל בפוסט שלי על הוכחת משפט גדל היא מופיעה. לעת עתה תצטרכו לסמוך עלי - פסוק כמו $latex S$ אפשר לכתוב בצורה הכי פורמלית בעולם.

בניסוח הזה של הפרדוקס אפשר להוכיח פורמלית שניתן להוכיח מתוך $latex S$ את זה ש-$latex D\notin\left\{ 1,2,3,4,5\right\} $, ובמילים אחרות - ש-$latex S$ סותר את עצמו. זה פותר במובן מסויים את הפרדוקס; כעת ברור מה הניסוח של הטענה של גוסונובסקי שממנו התלמידים מסוגלים להסיק את המסקנה שלהם, וגם די ברור שכשגוסונובסקי אומר "יהיה בוחן פתע", האינטואיציה הראשונה שלנו לא מבינה את דבריו בתור משהו מורכב כמו $latex S$ ולכן אנחנו לא רואים כאן בעיה. גם כאן זו נקודה שאפשר לעצור בה, אבל אני רוצה להמשיך עוד קצת, ל[מאמר חדש יחסית](http://www.ams.org/notices/201011/rtx101101454p.pdf) מ-2010 של רן רז ושירה קריצ'מן ממכון וייצמן שלוקח את הרעיון קצת יותר רחוק.

הטענה שלהם היא כזו: מכיוון ש-$latex S$ סתירתי, אפשר להוכיח ממנו הכל (וכבר הזכרתי זאת בפוסט). אבל אם אפשר להוכיח ממנו הכל, אפשר להוכיח **גם** שהמבחן יהיה ביום חמישי ו**גם** שהוא יהיה ביום רביעי. אם כן, האם באמת אפשר לזהות "יכיחות" עם "ידיעה" כאן? אם אני רוצה לדעת מיהו ספרטקוס, וכולם אומרים לי שהם ספרטקוס, האם זה הוסיף לי ידע? כנראה שלא. לכן אנחנו רוצים לזהות ידע כאן עם "התלמידים יכולים להוכיח שהמבחן מתקיים ביום $latex n$ ולכל יום אחר הם לא יכולים להוכיח שהמבחן מתקיים ביום האחר". באופן פורמלי $latex S$ יראה כך:

$latex S\equiv\left(D\in\left\{ 1,2,3,4,5\right\} \right)\wedge\bigwedge\_{n=1}^{5}\left[D\ge n\to\left(\neg\mbox{Pr}\_{S}\left[D\ge n\to D=n\right]\vee\bigvee\_{k\ne n}\mbox{Pr}\_{S}\left[D\ge n\to D=k\right]\right)\right]$

החלק הפנימי אומר הפעם "אם המבחן לא התקיים עד יום $latex n$, אז או שאי אפשר להוכיח שהוא יתקיים ביום $latex n$, או שיש $latex k\ne n$ שגם עבורו אפשר להוכיח שהמבחן יתקיים ביום $latex k$".

כעת, נניח שהתלמידים רוצים להוכיח ש-$latex D\ne5$. הם מניחים בשלילה ש-$latex D=5$, וכמו קודם הם מוכיחים ש-$latex \mbox{Pr}\_{S}\left[D\ge5\to D=5\right]$. לרוע מזלם, הפעם זה לא מספיק כדי להסיק ש-$latex D\ne5$; חייבים גם להוכיח שעבור $latex 1\le k\le4$ מתקיים $latex \neg\mbox{Pr}\_{S}\left[D\ge5\to D=4\right]$.

"רגע אחד!" אולי אתם אומרים. "אבל מה ההגיון בטענה כמו $latex D\ge5\to D=4$? הרי ברור שהיא לא נכונה!" זה כמובן נכון; אבל למה שזה יאמר שהתלמידים לא יהיו מסוגלים להוכיח את זה? הם יהיו מסוגלים להוכיח את זה, **בתנאי שמערכת ההוכחה שלהם לא עקבית**. זה מעלה את השאלה - מהי בכלל מערכת ההוכחה של התלמידים?

מהשאלה הזו נמנעתי עד כה. גרמתי לכם לחשוב שמדובר על לוגיקה מסדר ראשון ותו לא, אבל כדי לפרמל מושגים כמו $latex \mbox{Pr}$ בתוך הלוגיקה עצמה חייבים להסתמך על שפה ומערכת אקסיומות שמסוגלות לבטא די הרבה דברים; וממילא אנחנו כנראה מניחים אינטואיטיבית שלתלמידים מותר להוכיח כל הוכחה שמתמטיקאי "רגיל" יכול להוכיח. במילים אחרות, אנחנו מניחים שאנחנו מעל ZF, מערכת האקסיומות הסטנדרטית של המתמטיקה. ומה שמשפט אי השלמות השני של גדל אומר הוא שאין לנו דרך להוכיח שהמערכת הזו עקבית "מתוך" המערכת.

איך זה מתקשר לבעיה של התלמידים? שהם יכולים להוכיח ש-$latex D\ne5$, **מתוך** ZF, רק אם הם ישללו את זה שאפשר להוכיח בה $latex D\ge5\to D=4$, כלומר רק אם הם ישללו את זה ש-ZF יכולה להוכיח סתירה, כלומר רק אם הם יכולים להוכיח ש-ZF **עקבית**. אבל זה בדיוק מה שמשפט אי השלמות השני של גדל מראה שאי אפשר לעשות.

הטיעון הוא למעשה קצת יותר עדין מזה. אם התלמידים מניחים ש-ZF עקבית, כמו שכל מתמטיקאי עושה, אז מההנחה הזו ינבע שאי אפשר להוכיח את $latex D\ge5\to D=4$ ולכן התלמידים יצליחו להוכיח ש-$latex D\ne5$ (בהנחה ש-ZF עקבית; אבל אם ZF לא עקבית על אחת כמה וכמה אפשר להוכיח ש-$latex D\ne5$). הבעיה תהיה בצעד הבא: כדי להוכיח ש-$latex D\ne4$ התלמידים צריכים להוכיח ש-$latex \mbox{Pr}_{S}\left[D\ge4\to D=4\right]$, אבל זה לא נכון: אי אפשר להוכיח את $latex D\ge4\to D=4$ רק מתוך $latex S$ כי בשביל ההוכחה הזו צריך קודם כל להוכיח ש-$latex D\ne5$ ובשביל זה צריך להניח ש-$latex \mbox{ZF}$ עקבית. במילים אחרות, צריך להחליף את $latex S$ ב-$latex S\wedge\mbox{CON}\left(\mbox{ZF}\right)$. אבל אם נעשה את זה, נקבל מערכת חדשה, שגם את העקביות שלה אי אפשר להוכיח&#8230; אני מקווה שאתם מבינים את העיקרון.
