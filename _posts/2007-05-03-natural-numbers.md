...
<ol>
	...
	<li>לכל מספר טבעי $latex a$ קיים מספר טבעי <strong>עוקב</strong>, שמסומן ב-$latex S(a)$.</li>
	<li>0 אינו העוקב של אף מספר.</li>
	<li>אם לשני מספרים אותו עוקב, הם שווים זה לזה. כלומר, $latex S(a)=S(b)$ גורר $latex a=b$.</li>
