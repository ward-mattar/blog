...
כאן אפשר לעצור ולהגיד "יש מעגליות? לא משחקים!". לגיטימי. אפשר גם לומר "אין שום דרך לכתוב פסוק $latex S$ כזה בגלל שהוא מכיל את עצמו וזו סתירה" או משהו בסגנון, אבל זה כבר לא יהיה לגיטימי. אחד מהקסמים המגניבים ביותר בלוגיקה - קסם שהוא בעל תפקיד חשוב בהוכחת משפט אי השלמות של גדל - הוא ש<strong>אפשר</strong> לבנות פסוקים שמתייחסים כך לעצמם, בעזרת טכניקה עקיפה ומחוכמת שלא אציג כרגע אבל בפוסט שלי על הוכחת משפט גדל היא מופיעה. לעת עתה תצטרכו לסמוך עלי - פסוק כמו $latex S$ אפשר לכתוב בצורה הכי פורמלית בעולם.
...
הטענה שלהם היא כזו: מכיוון ש-$latex S$ סתירתי, אפשר להוכיח ממנו הכל (וכבר הזכרתי זאת בפוסט). אבל אם אפשר להוכיח ממנו הכל, אפשר להוכיח <strong>גם</strong> שהמבחן יהיה ביום חמישי ו<strong>גם</strong> שהוא יהיה ביום רביעי. אם כן, האם באמת אפשר לזהות "יכיחות" עם "ידיעה" כאן? אם אני רוצה לדעת מיהו ספרטקוס, וכולם אומרים לי שהם ספרטקוס, האם זה הוסיף לי ידע? כנראה שלא. לכן אנחנו רוצים לזהות ידע כאן עם "התלמידים יכולים להוכיח שהמבחן מתקיים ביום $latex n$ ולכל יום אחר הם לא יכולים להוכיח שהמבחן מתקיים ביום האחר". באופן פורמלי $latex S$ יראה כך:

$latex S\equiv\left(D\in\left\{ 1,2,3,4,5\right\} \right)\wedge\bigwedge_{n=1}^{5}\left[D\ge n\to\left(\neg\mbox{Pr}_{S}\left[D\ge n\to D=n\right]\vee\bigvee_{k\ne n}\mbox{Pr}_{S}\left[D\ge n\to D=k\right]\right)\right]$
...
"רגע אחד!" אולי אתם אומרים. "אבל מה ההגיון בטענה כמו $latex D\ge5\to D=4$? הרי ברור שהיא לא נכונה!" זה כמובן נכון; אבל למה שזה יאמר שהתלמידים לא יהיו מסוגלים להוכיח את זה? הם יהיו מסוגלים להוכיח את זה, <strong>בתנאי שמערכת ההוכחה שלהם לא עקבית</strong>. זה מעלה את השאלה - מהי בכלל מערכת ההוכחה של התלמידים?
...
איך זה מתקשר לבעיה של התלמידים? שהם יכולים להוכיח ש-$latex D\ne5$, <strong>מתוך</strong> ZF, רק אם הם ישללו את זה שאפשר להוכיח בה $latex D\ge5\to D=4$, כלומר רק אם הם ישללו את זה ש-ZF יכולה להוכיח סתירה, כלומר רק אם הם יכולים להוכיח ש-ZF <strong>עקבית</strong>. אבל זה בדיוק מה שמשפט אי השלמות השני של גדל מראה שאי אפשר לעשות.
