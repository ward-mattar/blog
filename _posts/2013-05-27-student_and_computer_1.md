...
זו דוגמה די טיפשית, כי החישוב כאן הוא פשוט מאוד: היקף מלבן עם אורך צלעות a,b הוא פשוט a+b+a+b (כזכור, מלבן מורכב משני זוגות של צלעות זהות ומקבילות). דרך אחרת לכתוב את זה בקיצור היא {::nomarkdown}\( 2(a+b)\){:/nomarkdown}. אם כן, כל מה שהתוכנית שלנו צריכה לעשות הוא זה:
<ol>
	<li>קלוט שני מספרים a,b.</li>
	<li>חשב את {::nomarkdown}\( 2(a+b)\){:/nomarkdown}.</li>
