...
מה התעלול? נניח ש-{::nomarkdown}\( p\left(x_{1},\dots,x_{n}\right)\){:/nomarkdown} היא משוואה שאנחנו רוצים לבדוק אם יש לה פתרון בשלמים חיוביים. אז נמיר אותה למשוואה המוזרה הבאה:
