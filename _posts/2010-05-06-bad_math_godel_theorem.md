...
אז רגע, מה כן קורה בהוכחה של משפט גדל? <a href="http://www.gadial.net/?p=193">ניסיתי לתאר זאת בפירוט בעבר</a> - השורה התחתונה היא שעבור תורה {::nomarkdown}\( T\){:/nomarkdown} בונים משפט שבדרך מחוכמת ועקיפה מצליח לומר "לא קיימת עבורי הוכחה בתוך התורה {::nomarkdown}\( T\){:/nomarkdown}". מה בין זה ובין משפטים שמוכיחים את עצמם - אין לי מושג.
