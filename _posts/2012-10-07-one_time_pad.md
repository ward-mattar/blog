...
date: 2012-10-07T18:24:55+00:00
author: gadial
layout: post
guid: http://www.gadial.net/?p=2209
permalink: /2012/10/07/one_time_pad/
categories:
  - קריפטולוגיה
tags:
...
אפשר להכליל את השיטה הזו גם למקרה שבו $latex P$ לא מורכב רק מאפסים ואחדים אלא, נאמר, מאותיות הא"ב. במקרה הזה נוח לחשוב על כל אות כמייצגת את המספר הסידורי שלה בא"ב פחות 1. למשל א' היא 0, ב' היא 1 ואילו ת' היא 21. כעת אפשר "לחבר" אותיות על ידי כך שמחברים את המספרים שלהן; אם התוצאה היא לפחות 22 פשוט נחסר ממנה 22. כלומר, $latex 21+1=22$ שהוא גדול מכדי לייצג אות ולכן נחשוב על התוצאה כעל $latex 21+1=0$ (ובדומה, $latex 17+9=4$, למשל). לחשבון המוזר הזה שבו אם חורגים מגבול כלשהו $latex n$ פשוט מחסרים מהתוצאה $latex n$ קוראים **חשבון מודולרי** ואומרים שזה חשבון **מודולו** $latex n$ אם $latex n$ הוא הגבול; אם תחשבו על זה, XOR הוא בעצם חשבון מודולרי מודולו 2.
...
שנון הגדיר צופן מושלם ככזה שראיית כתב הסתר בו אינה מוסיפה לנו אינפורמציה. הנה דרך פשוטה לתאר איך דבר כזה קורה מבחינה מתמטית: אם **לכל** כתב גלוי $latex P$, ו**לכל** כתב סתר $latex C$ **קיים** מפתח $latex K$ **יחיד** כך שהצפנת $latex P$ עם $latex K$ מחזירה את $latex C$, **וגם** ההסתברות של כל $latex K$ לשמש כמפתח היא שווה, אז הצופן יהיה מושלם. אבל למה?
...
כלומר, קיבלנו שההסתברות ש-$latex P=1$, כשהיא מותנית בכך ש-$latex C=1$, היא אותה הסתברות בדיוק כמו ההסתברות ש-$latex P=1$ בלי שום התניה. בלשון מתמטית זה אומר שהמאורע $latex P=1$ והמאורע $latex C=1$ הם **בלתי תלויים** &#8211; אין בידיעה שאחד מהם התקיים כדי לתת לנו אינפורמציה כלשהי על השני.
...
אם לכל כתב גלוי $latex P=a$ וכתב סתר $latex C=b$ קיים מפתח אחד ויחיד $latex k\_{a,b}$ שמעביר את $latex a$ ל-$latex b$, ואם הסתברות כל המפתחות שווה לאיזה ערך $latex p\_{K}$, אז ראשית כל

$latex \mbox{Pr}\left[P=a,C=b\right]=\mbox{Pr}\left[P=a,K=k\_{a,b}\right]=\mbox{Pr}\left[P=a\right]\cdot p\_{K}$
...
$latex \mbox{Pr}\left[C=b\right]=\sum\_{a\in\mathcal{P}}\mbox{Pr}\left[P=a,K=k\_{a,b}\right]=\sum\_{a\in\mathcal{P}}\mbox{Pr}\left[P=a\right]\cdot p\_{K}=p\_{K}\cdot\left(\sum\_{a\in\mathcal{P}}\mbox{Pr}\left[P=a\right]\right)=p_{K}$
