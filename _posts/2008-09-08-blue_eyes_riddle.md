...
כבר ראינו את בסיס האינדוקציה - כלומר, שבהינתן כחול עיניים אחד הוא עוזב ביום הראשון - ונותר להראות את צעד האינדוקציה. אם כן, נניח שאם יש {::nomarkdown}\( n\){:/nomarkdown} כחולי עיניים על האי, הם עוזבים בסוף היום ה-{::nomarkdown}\( n\){:/nomarkdown}. כעת נעסוק במקרה שבו יש {::nomarkdown}\( n+1\){:/nomarkdown} כחולי עיניים באי. כל כחול עיניים רואה {::nomarkdown}\( n\){:/nomarkdown} כחולי עיניים, ואומר לעצמו "אם אני לא כחול עיניים אז יש רק {::nomarkdown}\( n\){:/nomarkdown} כחולי עיניים באי, ולכן ביום ה-{::nomarkdown}\( n\){:/nomarkdown} כולם יסתלקו" (כשהחלק האחרון של דבריו נובע מהנחת האינדוקציה). אם זה לא קורה, נובע מכך שגם מי שאמר זאת לעצמו הוא כחול עיניים, ולכן הוא יעזוב ביום ה-{::nomarkdown}\( n+1\){:/nomarkdown} - וזה יקרה לכל כחולי העיניים. במה הם נבדלים מבעלי עיניים בצבע אחר? שמי שיש לו עיניים בצבע אחר רואה {::nomarkdown}\( n+1\){:/nomarkdown} כחולי עיניים מראש, ולכן אם בלילה ה-{::nomarkdown}\( n\){:/nomarkdown} אף אחד לא עוזב, זה עדיין לא אומר לו כלום.
