...
נתחיל מזה שלא באמת נבצע את הרדוקציה מבעיית העצירה, אלא מבעיה קצת יותר "פשוטה" - הבעיה הבאה: בהינתן מכונת טיורינג, צריך להכריע האם היא עוצרת על הקלט הריק או לא. לכאורה, זה מקרה פרטי של בעית העצירה, ולכן אולי כריע; בפועל, אפשר לבצע בקלות רדוקציה מבעית העצירה אליו: בהינתן מכונה $latex M$ וקלט $latex x$ משתמשים בתעלול ה"סינון" ש<a href="http://www.gadial.net/?p=70">כבר ראינו</a> ב<a href="http://he.wikipedia.org/wiki/%D7%9E%D7%A9%D7%A4%D7%98_%D7%A8%D7%99%D7%99%D7%A1">משפט רייס</a>, בונים מכונה $latex M_x$ שמריצה את $latex M$ על $latex x$ ורק אחרי שהריצה הסתיימה (<strong>אם</strong> היא הסתיימה) מתפנים להתעסק עם הקלט ה"אמיתי" של המכונה - בואו נניח שפשוט עוצרים תמיד. לכן, אם אלגוריתם שפותר את הבעיה "הפרטית" אומר על $latex M_x$ שהיא עוצרת, אז $latex M$ עוצרת על $latex x$; ואם לא, אז לא.
