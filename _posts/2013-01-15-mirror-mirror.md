...
שימו לב שאפשר גם את האפשרות האחרת, "שיקוף של התמונה ביחס לציר $latex y$ כאשר התמונה <strong>מימין</strong> לציר והוא נוגע בקצה ה<strong>שמאלי</strong> שלה":
...
אפשר היה גם לשקף ביחס לציר $latex y$ שעובר באמצע התמונה ואז במקום לקבל שני עותקים היינו פשוט מקבלים את התמונה במהופך.<strong>
</strong>

בשלב הזה אני מקווה שאתם כבר מתחילים לקבל תחושה שמה שקורה במראה הוא לא בדיוק שיקוף ביחס לציר $latex y$, למרות שכך יצרתי את התמונה של "מה ונוס רואה במראה". הסיבה לכך היא ששיקוף ביחס לציר $latex y$ היה אמור ליצור את הדמות שבמראה <strong>ליד</strong> ונוס עצמה, ולא <strong>מול</strong> ונוס. אבל כשאני מדבר על "מול" אני מכניס לתמונה את השחקן שעד כה לא דיברתי עליו - המימד השלישי, ציר $latex z$.
