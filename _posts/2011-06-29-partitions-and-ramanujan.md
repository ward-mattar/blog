...
בדוגמה שלעיל $latex b_{2}=3$ ו-$latex b_{1}=1$ ו-$latex m=1$ ו-$latex l=13$, ואז יוצא ש-$latex A=6$. תרגיל למתקדמים: נסו להבין כיצד ה-1007 וה-6 נובעים מהדרישה שלנו להצטמצם למקרים שבהם החלוקה ב-24 אינה מניבה שבר.
