...
date: 2016-01-31T23:32:08+00:00
author: gadial
layout: post
guid: http://www.gadial.net/?p=3310
permalink: /2016/01/31/flat_earth_fun/
categories:
...
על פניו, זה עשוי להישמע לכם מוזר. הרי את העובדה שהארץ אינה שטוחה ידעו עוד משחר ההיסטוריה. ידוע במיוחד ארטוסתנס היווני שחישב את רדיוס כדור הארץ ברמת דיוק יפה מאוד לזמנו בדרך מחוכמת ויפה [שראויה לפוסט בבלוג, מתישהו](http://www.gadial.net/2016/07/27/eratosthenes_circumference/). הנימוקים לכך שהארץ אינה שטוחה הם רבים ומגוונים, אבל הטובים ביותר נוגעים בכלל לשמש ולירח - הצל שהארץ מטילה על הירח, למשל, או העובדה שאם הארץ הייתה שטוחה השמש הייתה צריכה להאיר את כל היבשות בו זמנית, וכדומה. בימינו המודרניים גם יש לנו תמונות לווין של הארץ שלא ממש משאירות מקום לספק באשר לצורתה. הנה [מאמר](http://www.popsci.com/10-ways-you-can-prove-earth-is-round) נחמד שמסכם כמה מהגישות אם אתם סקרנים.

ועדיין, אנשים שמאמינים בכל ליבם שהארץ שטוחה ושכל העדויות הן שקרים וטעויות קיימים ופעילים וכנראה יהיו פעילים לעד. הנה, ממש עכשיו העניין קפץ שוב לכותרות עם איזה ראפר שהתחיל להפיץ בטוויטר [שלל שטויות](http://gawker.com/why-the-earth-is-flat-straight-from-the-mouth-of-a-ver-1754933801) הקשורות לנושא. והטריגר לפוסט הוא אחת מהן. הנה היא:

**[<img class="aligncenter size-full wp-image-3311" src="http://www.gadial.net/wp-content/uploads/2016/01/CZkrOKqUAAA8wSH.jpg" alt="CZkrOKqUAAA8wSH" width="600" height="564" />](http://www.gadial.net/wp-content/uploads/2016/01/CZkrOKqUAAA8wSH.jpg)**
...
[<img class="aligncenter size-full wp-image-3314" src="http://www.gadial.net/wp-content/uploads/2016/01/flat_earth2.png" alt="flat_earth2" width="491" height="458" />](http://www.gadial.net/wp-content/uploads/2016/01/flat_earth2.png)

בואו נתחיל עם שאלת המרחק מהאופק. לצורך כך אני אשתמש במה שידוע לנו על גאומטריה אוקלידית של מעגלים, ובבניית עזר פשוטה: אני אעביר שני רדיוסים של המעגל מתוך מרכזו - האחד אל הנקודה על פני השטח שאני נמצא מעליה, והשניה אל הנקודה שבה הקו המשיק לאופק שלי נוגע בכדור הארץ. הגאומטריה האוקלידית יודעת ש"רדיוס מאונך למשיק בנקודת ההשקה", ולכן קיבלנו משולש ישר זווית שאורך היתר שלו הוא $latex R+a$ ואילו אורכי הניצבים הם $latex R$ ו-$latex x$, כאשר $latex x$ הוא המרחק אל האופק שאני מחפש. עכשיו נכנס לתמונה **משפט פיתגורס** שאומר שריבוע היתר במשולש ישר זווית שווה לסכום ריבועי הניצבים, ואומר לנו ש-$latex \left(R+a\right)^{2}=R^{2}+x^{2}$, ולכן קיבלנו ש-$latex x=\sqrt{a^{2}+2Ra}$.

בואו נחשב מה זה אומר על הר דנאלי, כלומר נציב את הנתונים בתמונה שלהם. אצלם $latex a=102$, אבל 102 **מה**? כאן צריך להתחשב ביחידות האורך שלהם. ואלו, באופן מצער, יחידות מדידה אמריקאיות מופרעות. לא נורא - גיגול קצר נותן לנו את הקבועים שבהם צריך לכפול את המספרים כדי לקבל אורך בקילומטרים. עכשיו נשאר רק לפתוח מחשבון, או במקרה שלי, את Sage:

<pre class="brush: ruby; title: ; notranslate" title="">sage: f_to_k = 0.0003048
...
<pre class="brush: ruby; title: ; notranslate" title="">sage: a = 0.47
sage: x = sqrt(a^2+2*R*a)
sage: x.n()
77.5846613623756
</pre>
...
[<img class="aligncenter size-full wp-image-3312" src="http://www.gadial.net/wp-content/uploads/2016/01/flat_earth3.png" alt="flat_earth3" width="491" height="458" />](http://www.gadial.net/wp-content/uploads/2016/01/flat_earth3.png)

סימנתי ב-$latex b$ רק את החלק מההר שמוסתר. קיבלנו משולש שמורכב משני הרדיוסים וההמשכים שלהם, ועוד הקו המשיק. המשולש הזה מחולק לשני משולשים קטנים יותר, ישרי זווית, עם אורכי יתר שהם $latex R+a$ ו-$latex R+b$, וניצב אחד שהוא באורך $latex R$. זה נותן לנו את הזהויות הבאות, עבור הזוויות $latex \alpha,\beta$ שמופיעות שם:

$latex \cos\alpha=\frac{R}{R+a}$

$latex \cos\beta=\frac{R}{R+b}$

עכשיו, את $latex a$ אנחנו יודעים, ולכן את $latex \alpha$; אבל את $latex b$ אנחנו מחפשים, ולכן אנחנו רוצים לקבל את $latex \beta$ בדרך אחרת ואז להשתמש בכך ש-$latex b=\frac{R}{\cos\beta}-R$. למזלנו, אנחנו יודעים מהו $latex \alpha+\beta$ כי ידוע לנו מה המרחק בין אנקורג' להר דנאלי. בואו נסמן את המרחק הזה ב-$latex d$. זה **אורך קשת** כלשהו של המעגל, כשאורך הקשת כולה הוא $latex S$. זה אומר שהחלק היחסי שהקשת הזו תופסת מכלל המעגל הוא $latex \frac{d}{S}$. הזווית שתיווצר על ידי הקשת הזו תהיה, אם כן, בעלת אותו יחס אל הזווית הכוללת של המעגל, שהיא $latex 2\pi$ (אנחנו מודדים זוויות ברדיאנים כאן). במילים אחרות, $latex \frac{\alpha+\beta}{2\pi}=\frac{d}{S}$, או $latex \beta=\frac{2\pi d}{S}-\alpha$. בואו נבצע כעת את החישובים:

<pre class="brush: ruby; title: ; notranslate" title="">sage: d = 130*m_to_k
