...
date: 2013-07-04T08:54:06+00:00
author: gadial
layout: post
guid: http://www.gadial.net/?p=2623
permalink: /2013/07/04/student_and_computer_8/
categories:
  - תכנות
tags:
...
<pre class="brush: ruby; title: ; notranslate" title=""># puts &quot;The maximum among #{ARGV.join(&quot;, &quot;)} is #{ARGV.collect{|x| x.to_i}.max}&quot;
...
<pre class="brush: ruby; title: ; notranslate" title="">a = [1,2,3,4,5]
b = a.collect{|x| x*x}
puts a.inspect
puts b.inspect
</pre>
...
$latex f\left(x\right)=\begin{cases} 0 & x=1\\ 42 & x=2\\ x^{2} & \mbox{otherwise} \end{cases}$
